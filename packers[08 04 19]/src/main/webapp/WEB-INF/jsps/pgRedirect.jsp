<%@page import="com.packers.bo.PaytmConstants"%>
...
<%
    ...
    parameters.put("CALLBACK_URL", "http://localhost:8090/packers/pgResponse2");
    parameters.put("ORDER_ID", "order1");
    parameters.put("TXN_AMOUNT", "1234.12");
    parameters.put("PAYMENT_MODE_ONLY", "YES");
    parameters.put("AUTH_MODE", "3D ");
    parameters.put("PAYMENT_TYPE_ID", "CC");
